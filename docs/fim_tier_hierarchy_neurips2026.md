...
| 11 | The substrate class extends beyond our 12-class panel (e.g. to MoE, MLP-Mixer, SSM variants we have not tested) | **Conjectural** (open) | requires out-of-panel measurement |
