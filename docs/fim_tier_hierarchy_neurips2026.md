...
| 7 | Production-scale checkpoints (ResNet-50 V1+V2, ViT-L/16, GPT-2-medium 5-seed multi-seed, GPT-2-large, Pythia-1.4B, ViT-B/16-trajectory-from-scratch, ImageNet-1K ResNet-50 from-scratch) sit firmly in the deep-sequential band on every measured trained checkpoint | **Empirically supported, multi-seed CIs where seed cost permitted** | V9.5–V9.8 + multi-seed `v9_multi_seed_production_results.json` + `v9_6_gpt2_medium_5seed_results.json` + `v9_6b_gpt2_large_results.json` + `v9_8_pythia_1.4b_results.json` + `v9_8b_vit_imagenette_trajectory_results.json` + ImageNet ResNet-50 from-scratch trajectory `v9_5c_imagenet_resnet50_fromscratch_results.json` |
